...
const cartListReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        ...
        case "INCREMENT":
          ...
          const elementIndex = state.cartList[3].findIndex(element => element.id == payload.id)
          const newArr = [...state.cartList[3]]
          console.log(newArr)
          newArr[elementIndex] = {... newArr[elementIndex], count: newArr[elementIndex].count+1}
          console.log(newArr)
          const obj = {
            ...state.cartList,
            3:newArr
        ...
        case "DECREMENT":
          console.log(state.cartList[3])
          const elementIndex2 = state.cartList[3].findIndex(element => element.id == payload.id)
          const newArr2 = [...state.cartList[3]]
          console.log(newArr2)
          newArr2[elementIndex2] = {... newArr2[elementIndex2], count: newArr2[elementIndex2].count-1}
          console.log(newArr2)
          const obj2 = {
            ...state.cartList,
            3:newArr2

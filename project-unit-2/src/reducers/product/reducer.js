     ...
     products : [
        {
            ...
            price : 9499,
            description : "processor type M1 Pro 8-core CPU 16-core Neural Engine graphics card 14-core GPU display type Liquid Retina XDR Display display size 14.2 operating system MacOS Monterey product type Laptop model series (Apple) MacBook Pro generation/release 2021 color Space Grey capacity 512 GB SSD RAM 16 GB RAM ",
            category : "Laptops",
        ...
        },
        {
            ...
            price : 6799,
            description : "SKU: 567509 Manufacturer No :SMF926BZSDMEA capacity: 256 GB display size :7.6 (Secondary Display) cam resolution Rear: 12 MP + 12 MP + 12 MP/Front: 10 MP + 4 MP (UDC)",
            category : "Mobiles",
        ...
        },
        {
            id : 7,
            name : "Honor 20 Pro ",
            description: "capacity 256 GB display size 6.26 cam resolution Rear: 48 MP + 16 MP + 8 MP + 2 MP/Front: 32 MP camera special features 3X Optical/5X Hybrid/up to 30X Digital Zoom, SuperWide Angle/Telephoto/Macro processor cores Octa Core battery capacity 4000 mAh product type Smartphone operating system Android v9.0 (Pie) supported network 4G LTE ",
            price : 2189 ,
            category : "Mobiles",
        ...
        },
        {
            ...
            price : 3799,
            category : "Mobiles",
            description : "capacity 128 GB display size 6.1 cam resolution Rear: 12 MP + 12 MP/Front: 12 MP camera special features 2X Optical Zoom, Night Mode, Optical Image Stabilization, Digital Zoom up to 5X",
        ...
        },
        {
            ...
            price : 6599,
            category : "Tablets",
            description : "operating system iPadOS display type Liquid Retina Display display size 12.9processor cores Octa Coreproduct type Tablet PC - 4G Support ",
        ...
        },
        {
            ...
            price : 1149,
            category : "Tablets",
            description : "operating system Android v10 + EMUI 10.1 display type IPS-LCD Touchscreen display size 10.4 processor cores Octa Coreprocessor speed 	2X 2.27 (Cortex A76) + 6X 1.88 (Cortex A55) GHz ",
        ...
        },
        {
            ...
            price : 2949,
            category : "Tablets",
            description : "operating system iOS 12 display type Retina Displaydisplay size 	7.9 product type Tablet PC - 4G Supportmodel series 	(Apple) iPad Minigeneration/release (iPad Mini) 2019 operating system architecture 	64 bit supported network 4G ",
        ...
        },
        {
            ...
            price : 1432,
            category : "Tablets",
            description : "operating system Android v10.0 display type 	IPS FHD-LCD Touchscreen display size 	10.3 processor cores 	Octa Core processor speed 	2 GHz product type 	Tablet PC - 4G Support ",
        ...
        },
        {
            ...
            price : 6000,
            category : "Laptops",
            description : "processor type 	Intel Core i7-11800H graphics card NVIDIA GeForce RTX 3050 Ti (4 GB) display type FHD IPS 144 Hz Display display size 15.6 operating system Windows 10 product type Gaming Laptop model series (MSI) GF generation/release 2021 color Black operating system architecture 64 bit processor speed 2.3 GHz VR (virtual reality) enabled VR Enabled capacity 1 TB SSD RAM 16 GB RAM ",

...
function Filter() {
  ...
  const filter = (min, max) => {
    ...
    const results = state.products.filter(
      (e) => e.category === Category && e.price >= min && e.price <= max
    );
    ...
    <>
      <div className="filter">
        ...
        <div className="form-2">
          ...
          <label>
            <input type="radio" onChange={byprice} name="Price" value="3000" />
            under 3000 SAR
          </label>
          <label>
            <input type="radio" onChange={byprice} name="Price" value="3001" />
            3000 SAR to 5000 SAR
          </label>
          <label>
            <input type="radio" onChange={byprice} name="Price" value="5001" />
            5000 SAR to 7000 SAR
          </label>
          <label>
            <input type="radio" onChange={byprice} name="Price" value="7001" />
            7000 SAR to 10000 SAR
          </label>
          <label>
            <input type="radio" onChange={byprice} name="Price" value="10000" />
            10000 SAR And Above
          </label>
        </div>
